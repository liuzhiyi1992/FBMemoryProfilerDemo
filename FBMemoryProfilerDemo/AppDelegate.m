...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    FBObjectGraphConfiguration *configure = [[FBObjectGraphConfiguration alloc] initWithFilterBlocks:@[FBFilterBlockWithObjectIvarRelation(NSClassFromString(@"FBMemoryProfilerViewController"), @"_timer")] shouldInspectTimers:YES];
